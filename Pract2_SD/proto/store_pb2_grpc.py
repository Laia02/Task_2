...
class KeyValueStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.addSlave = channel.unary_unary(
                '/distributedstore.KeyValueStore/addSlave',
                request_serializer=store__pb2.slaveRequest.SerializeToString,
                response_deserializer=store__pb2.slaveResponse.FromString,
                )
...
def add_KeyValueStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'addSlave': grpc.unary_unary_rpc_method_handler(
                    servicer.addSlave,
                    request_deserializer=store__pb2.slaveRequest.FromString,
                    response_serializer=store__pb2.slaveResponse.SerializeToString,
            ),
...
class KeyValueStore(object):
    ...
    def addSlave(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/distributedstore.KeyValueStore/addSlave',
            store__pb2.slaveRequest.SerializeToString,
            store__pb2.slaveResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
