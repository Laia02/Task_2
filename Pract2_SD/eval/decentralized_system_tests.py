...
class TestDecentralizedSystem(unittest.TestCase):
    ...
    def test_system_scalability_and_performance(self):
        ...
        print("\033[32mTesting system scalability and performance\033[0m")
    ...
    def test_system_scalability_and_performance_with_slowdown(self):
        # Slow down 
        print("\033[32mTesting system scalability and performance with slowndown nodes\033[0m")
        time.sleep(0.5)
    ...
    def test_node_failure_during_transaction(self):
        print("\033[32mTesting node failure during transaction\033[0m")
