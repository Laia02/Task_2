...
proto_directory = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../proto')
...
class TestCentralizedSystem(unittest.TestCase):
    ...
    def connect_to_grpc_servers(self, slave_configs):
        ...
        for slave_config in slave_configs:
            channel, stub = self.connect_to_grpc_server(slave_config['ip'], slave_config['port'])
    ...
    def test_put_success(self):
        ...
        print('\033[91m'+"TEST:Put operation started."+'\033[0m')

        """Test that a successful put operation correctly updates the data."""
        response = self.stub_put.put(store_pb2.PutRequest(key="test_key", value="test_value"))
        self.assertTrue(response.success)
        print("TEST:Put operation successful.")

    def test_get_correctness(self):

        print('\033[91m'+"TEST:Get operation started."+'\033[0m')
        ...
        print("TEST:Get operation successful.")


    def test_concurrent_access(self):
        """Test handling of concurrent put and get requests."""
        print('\033[91m'+"TEST:Concurrent operation started."+'\033[0m')
    ...
    def test_system_scalability_and_performance(self):
        ...
        print('\033[91m'+"TEST:Scability operation started."+'\033[0m')
    ...
    def test_system_scalability_and_performance_with_slowdown_slave(self):
        ...
        print('\033[91m'+"TEST:Slowdown slave operation started."+'\033[0m')
    ...
    def test_system_scalability_and_performance_with_slowdown_master(self):
        ...
        print('\033[91m'+"TEST:Slowdown master operation started."+'\033[0m')
    ...
    def perform_operations(self, operations_per_process):
        channel_put, stub_put = self.connect_to_grpc_server(self.config['master']['ip'], self.config['master']['port'])
        channels_get, stubs_get = self.connect_to_grpc_servers(self.config['slaves'])
        for _ in range(operations_per_process):
            stub_put.put(store_pb2.PutRequest(key="perf_key", value="perf_value"))
            random.choice(stubs_get).get(store_pb2.GetRequest(key="perf_key"))

    def test_state_recovery_after_critical_failure(self):
        """Test the system's ability to recover state after a critical failure."""

        print('\033[91m'+"TEST:Recovery operation started."+'\033[0m')
    ...
    def test_node_failure_during_transaction(self):
        ...
        print('\033[91m'+"TEST:Failure operation started."+'\033[0m')
